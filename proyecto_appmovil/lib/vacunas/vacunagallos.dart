...
class vacunagallos extends StatefulWidget {
  vacunagallos({
    super.key,
    required this.id,
    required this.apodo,
  ...
  State<vacunagallos> createState() => _listState();
}

class _listState extends State<vacunagallos> {
