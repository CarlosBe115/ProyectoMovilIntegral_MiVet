...
import 'package:proyecto_appmovil/vacunas/vacunasanimal.dart';

// ignore: camel_case_types
class formularioanimal extends StatefulWidget {
  ...
  @override
  State<formularioanimal> createState() => _listState();
}

// ignore: camel_case_types
class _listState extends State<formularioanimal> {
  final _url2 = Uri.parse('https://mivetapi.somee.com/api/animal');
